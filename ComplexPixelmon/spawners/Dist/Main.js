...
function get_odds_emoji(percent) {
    if (percent === 100)
        return "✅";
    if (percent >= 75)
        return "🟢";
...
function filter() {
    // get HTML elements
    const cmbbox = document.getElementById("mons");
    const html_search = document.getElementById("search");
...
function show_mon(event) {
    const select = event.target;
    const mon = select.value;
    // get HTML elements
    const html_map = document.getElementById("map");
    const html_sprite = document.getElementById("sprite");
...
function init(check_sprite_exists = false) {
    // get HTML elements
    const html_search = document.getElementById("search");
    const html_results = document.getElementById("results");
    const cmbbox = document.getElementById("mons");
